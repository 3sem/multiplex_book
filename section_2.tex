...
\textbf{Задача 1.} Реализуйте мультиплексирование ввода-вывода для дескрипторов, абстрагирующих логические соединения с TCP-сервером. Используйте любой из примитивов для мультиплексирования, рассмотренный в Главе 1.

\textbf{Задача 2.} Воспроизведите эксперимент по измерению накладных расходов на одновременный мониторинг различного количества дескрипторов для \verb|poll|,\verb|epoll|, постройте сводную таблицу и объясните результаты. При этом можно использовать как методику из Главы 1, так и собственную, которую также следует описать и неформально обосновать.
